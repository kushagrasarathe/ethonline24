export const SSV_NETWORK_ADDRESS = "0x38A4794cCEd47d3baf7370CcC43B560D3a1beEFA";

export const SSV_NETWORK_ABI = [
  ...
  { inputs: [], name: "EmptyPublicKeysList", type: "error" },
  {
    inputs: [{ internalType: "uint64", name: "operatorId", type: "uint64" }],
  ...
  { inputs: [], name: "InvalidWhitelistAddressesLength", type: "error" },
  {
    inputs: [
      { internalType: "address", name: "contractAddress", type: "address" },
    ],
  ...
  { inputs: [], name: "PublicKeysSharesLengthMismatch", type: "error" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "toPrivate", type: "bool" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bytes", name: "shares", type: "bytes" },
      {
        components: [
          { internalType: "uint32", name: "validatorCount", type: "uint32" },
          { internalType: "uint64", name: "networkFeeIndex", type: "uint64" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "contract ISSVDAO", name: "ssvDAO_", type: "address" },
      {
  ...
  },
  {
    inputs: [
      { internalType: "bytes", name: "publicKey", type: "bytes" },
      { internalType: "uint256", name: "fee", type: "uint256" },
      { internalType: "bool", name: "setPrivate", type: "bool" },
    ],
  ...
  {
    inputs: [
      { internalType: "enum SSVModules", name: "moduleId", type: "uint8" },
